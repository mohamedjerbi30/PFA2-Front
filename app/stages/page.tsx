...
export default function StagesPage() {
  ...
  const getScoreColor = (score) => {
    ...
    if (score >= 75) return 'text-[#1988A7]';
  ...
  return (
    <ProtectedRoute>
      <div className="min-h-screen bg-gray-50">
        {/* Header */}
        <div className="bg-gradient-to-r from-[#B91633] to-[#1988A7] text-white">
          ...
          <div className="bg-white rounded-lg shadow-sm mb-6">
            <div className="flex border-b">
              <button
                ...
                className={`px-6 py-4 font-medium transition-colors ${activeTab === 'offres'
              ...
              <button
                ...
                className={`px-6 py-4 font-medium transition-colors ${activeTab === 'candidatures'
                    ? 'text-purple-600 border-b-2 border-purple-600'
                    : 'text-gray-600 hover:text-gray-900'
                  }`}
              >
              ...
              <button
                ...
                className={`px-6 py-4 font-medium transition-colors ${activeTab === 'stagiaires'
                    ? 'text-purple-600 border-b-2 border-purple-600'
                    : 'text-gray-600 hover:text-gray-900'
                  }`}
              >
                ...
                <div key={candidature.id} className="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow">
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex gap-3">
                        <button className="px-4 py-2 bg-[#1988A7] text-white rounded-lg hover:bg-[#146d8a] transition-all shadow-md hover:shadow-lg">
                          Voir CV complet
                        </button>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-xl max-w-2xl w-full p-8">
              ...
              <div className="bg-blue-50 rounded-lg p-4 mb-6">
                <div className="flex gap-3">
                  <Brain className="w-6 h-6 text-[#1988A7] flex-shrink-0" />
                  <div>
